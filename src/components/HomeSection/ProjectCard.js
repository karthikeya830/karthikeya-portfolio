...
const ProjectCard = (props) => {
  ...
  return (
    <div>
      <div
        className= 'projectbox border-none cursor-pointer flex h-60 w-fit max-w-xs text-white rounded-lg overflow-hidden project-card transform transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-md '
      >
